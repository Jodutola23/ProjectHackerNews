...
class StoryList {
  ...
  /** Add story data to API, make a Story instance, add it to story list:
...
class User {
  ...
  /** Log in user with API, make User instance & return it:
  ...
  /** Log in user via stored credentials (token & username):
   * - token: user's token
